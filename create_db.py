...
class Request(Base):
    ...
    send_or_no = Column(Boolean, nullable=True)
...
db_url = f"postgresql+psycopg2://{DATABASE['user']}:{DATABASE['password']}@{DATABASE['host']}:{DATABASE['port']}/{DATABASE['database']}?client_encoding=utf8"
